...
import com.jmarcos.demoparkapi.web.dto.UsuarioSenhaDto;
...
public class UsuarioIT {
    ...
    @Test
    public void createUsuario_ComUsernameEUsernameInvalidos_RetornarErrorMessageStatus422(){
    ...
    public void createUsuario_ComPasswordInvalidos_RetornarErrorMessageStatus422(){
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioCreateDto("tody@email.com@", "12346"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    @Test
    public void editarSenha_ComCamposInválidos_RetornarErrorMessageComStatus422() {
        ErrorMessage responseBody = testClient
                .patch()
                .uri("/api/v1/usuarios/100")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void editarSenha_ComSenhasInválidas_RetornarErrorMessageComStatus400() {
        ErrorMessage responseBody = testClient
                .patch()
                .uri("/api/v1/usuarios/100")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioSenhaDto("123456", "000000", "132456"))
                .exchange()
